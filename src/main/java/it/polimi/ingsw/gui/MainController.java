...
import it.polimi.ingsw.gui.client.NetworkHandler;
...
public class MainController implements Initializable{
    ...
    public void play(MouseEvent mouseEvent) throws Exception{
        ...
        dataBase.getControlState().computeInput(nick);
        networkHandler.update(dataBase.getControlState().computeInput(nick));*/

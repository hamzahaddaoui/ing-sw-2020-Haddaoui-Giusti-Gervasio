...
public class SelectingSpecialCommand extends State {
    ...
    public void showPane(){
        Platform.runLater(() -> Controller.replaceSceneContent("fxml_files/selectingSpecialCommand.fxml"));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        if(Database.getPlayerState() != PlayerState.ACTIVE){
            ...
            title.setText(Database.getMatchPlayers().get(Database.getCurrentPlayer()) + " is selecting his card...");
    ...
    public void sendData(){
        ...
        message.setGodCard(Database.getGodCard());
        notify(message);
    }

...
class ApolloDecoratorTest {
    ...
    void testMoveWorkerChange() {
        ...
        player1.getCommands().moveWorker(position3, player1);
    ...
    void testMoveWorkerNonChange() {
        ...
        player1.getCommands().moveWorker(worker.getPosition(), player1);
        Assert.assertEquals(match.getBillboard().getPlayer(position),player2.getID());
